...
namespace DataProcessors._3dExtruder
{
    ...
    public class Triangle3D
    {
        ...
        private readonly Material _floorMaterial = new DiffuseMaterial(new SolidColorBrush(Colors.Red));
        ...
        public Model3DGroup Model
        {
            get
            {
                return _points.Triangle(_floorMaterial);
            }
        }
    ...
    public class ExtrusionPlane
    {
        ...
        public ExtrusionPlane(Triangle3D[] triangles, Point3D center)
        {
            ...
            if (_triangles.Count(triangle => triangle.Normal() != _normal) != 0)
